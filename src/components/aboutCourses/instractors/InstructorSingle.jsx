							...
							<div className="page-header__content">
								...
								<div className="d-flex items-center mt-30">
									...
									<div className="d-flex items-center x-gap-15 text-white ml-25">
										{pageItem.socialProfile?.map(
											(itm, index) => (
												<a key={index} href={itm.url}>
													<i
														className={`fa ${itm.icon}`}
													></i>
												</a>
											)
										)}
								...
								<div className="tabs__content pt-60 lg:pt-40 js-tabs-content">
									...
									>
										...
										<p className="text-light-1 mt-30">
											...
											commodo ut, ultricies vitae velit.
											Ut nulla tellus, eleifend euismod
											pellentesque vel, sagittis vel
											justo. In libero urna, venenatis sit
											amet ornare non, suscipit nec risus.
											Sed consequat justo non mauris
											pretium at tempor justo sodales.
											Quisque tincidunt laoreet malesuada.
											Cum sociis natoque penatibus et
											magnis dis parturient montes,
											nascetur.
											<br />
											<br />
											Este curso é destinado a pessoas
											interessadas em Design UI/UX.
											Começaremos do início e
											trabalharemos passo a passo. Se você
											já tem alguma experiência em Design
											UI/UX, mas deseja se atualizar
											usando o Adobe XD, este curso também
											é perfeito para você!
											<br />
											<br />
											Primeiro, abordaremos as diferenças
											entre UX e UI Design. Veremos qual é
											o nosso briefing para este projeto
											do mundo real, em seguida,
											aprenderemos sobre wireframes de
											baixa fidelidade e como utilizar
											kits de design UI existentes.
										</p>
