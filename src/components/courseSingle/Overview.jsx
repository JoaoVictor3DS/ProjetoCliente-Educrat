			...
			>
				...
				>
					<p className="">
						...
						<br />
						<br />
						Este curso é destinado a pessoas interessadas em Design
						UI/UX. Começaremos do início e trabalharemos até o
						final, passo a passo. Se você já tem alguma experiência
						em Design UI/UX, mas deseja se atualizar usando o Adobe
						XD, este curso também é perfeito para você!
						<br />
						<br />
						Primeiro, abordaremos as diferenças entre Design UX e
						UI. Veremos qual é o nosso briefing para este projeto do
						mundo real, depois aprenderemos sobre wireframes de
						baixa fidelidade e como usar kits de design UI
						existentes.
					</p>
				</div>
