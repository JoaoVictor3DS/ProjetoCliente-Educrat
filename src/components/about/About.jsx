					...
					<div className="row y-gap-50 justify-between items-center">
						...
						<div className="col-lg-5">
							<h2 className="text-30 lh-16">
								Bem-vindo ao Educrat. Aprimore suas habilidades
								com os melhores cursos online
							</h2>
							<p className="text-dark-1 mt-30">
								Você pode começar e terminar um desses cursos
								populares em menos de um dia – gratuitamente!
								Confira a lista abaixo. Faça o curso
								gratuitamente.
							</p>
							<p className="pr-50 lg:pr-0 mt-25">
								Neque convallis a cras semper auctor. Libero id
								faucibus nisl tincidunt egetnvallis a cras
								semper auctonvallis a cras semper aucto. Neque
								convallis a cras semper auctor. Liberoe
