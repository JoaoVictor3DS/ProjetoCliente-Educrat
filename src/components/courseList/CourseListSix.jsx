				...
				<div className="row">
					<div className="col-auto">
						<h2 className="text-24 lh-12">
							Todos os cursos de Interface do Usuário
						</h2>
					</div>
				</div>
						...
						<div className="row y-gap-60">
							{sortedFilteredData
								...
								.map((elm, i) => (
									<div
										key={i}
										className="col-12 border-bottom-light"
									>
