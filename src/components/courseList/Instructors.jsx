import { populerTags, teamMembersFull } from "@/data/instructors";
					...
					<div className="row y-gap-20 justify-between items-center">
						...
						<div className="col-auto">
							<div className="d-flex justify-center x-gap-15 items-center">
								<div className="col-auto">
									<button className="d-flex items-center text-24 arrow-left-hover js-events-slider-prev instructor-left">
										<i className="icon icon-arrow-left"></i>
									</button>
								</div>
								<div className="col-auto">
									<div className="pagination -arrows js-events-slider-pagination instructor-pagination"></div>
								</div>
								<div className="col-auto">
									<button className="d-flex items-center text-24 arrow-right-hover js-events-slider-next instructor-right">
					...
					<div className="overflow-hidden pt-50 lg:pt-40 js-section-slider">
						{showSlider && (
							<Swiper
								...
								navigation={{
									nextEl: ".instructor-right",
									prevEl: ".instructor-left",
								}}
								// loop={true}
								spaceBetween={30}
								slidesPerView={1}
