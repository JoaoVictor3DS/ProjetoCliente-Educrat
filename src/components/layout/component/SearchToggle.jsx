							...
							<div className="header-search__content mt-30">
								...
								<div className="d-flex y-gap-5 flex-column mt-20">
									...
									<Link
										...
										className="text-dark-1"
									>
										Escola de Arte de Personagens: Curso
										Completo de Desenho de Personagens
									</Link>
									<Link
										to="/courses-single-3/3"
										className="text-dark-1"
									>
										Criador Completo de Blender: Aprenda
									...
									<Link
										...
										className="text-dark-1"
									>
										Essenciais de Design de Experiência do
										Usuário - Adobe XD UI UX Design
									</Link>
									<Link
										to="/courses-single-5/3"
										className="text-dark-1"
									>
										Masterclass de Design Gráfico - Aprenda
										Design INCRÍVEL
									</Link>
									<Link
								...
								<div className="mt-30">
									<button className="uppercase underline">
										PRESSIONE ENTER PARA VER TODOS OS
