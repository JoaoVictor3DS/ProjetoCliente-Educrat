			...
			<section className="section-bg layout-pt-lg layout-pb-sm bg-light-4">
				<div className="section-bg__item -full">
					<div
						...
						style={{
							backgroundImage:
								"url(/assets/img/home-6/svg/bg.png)",
						}}
					></div>
				</div>
					...
					<div className="row y-gap-30 justify-between items-center">
						...
						<div className="col-lg-5 col-md-10">
							<h2 className="text-30 lh-15">
								...
								<br className="lg:d-none" /> Professores
							</h2>
							<p className="mt-10">
							...
							<div className="d-inline-block mt-35">
								<a
									href="#"
									className="button -md -dark-2 text-white"
								>
									Ver Mais
								</a>
							</div>
