export const footerLinks = [
	...
	},
	{
		...
		links: [
			...
			{ href: "/courses-single-6/3", label: "Negócios" },
			{ href: "/courses-single-6/3", label: "Finanças e Contabilidade" },
			{ href: "/courses-single-6/3", label: "TI e Software" },
			{
	...
	},
	{
		...
		links: [
			...
			{ href: "/courses-single-6/3", label: "Fotografia e Vídeo" },
			{ href: "/courses-single-6/3", label: "Saúde e Fitness" },
			{ href: "/courses-single-6/3", label: "Música" },
			{ href: "/courses-single-6/3", label: "Design de UX" },
